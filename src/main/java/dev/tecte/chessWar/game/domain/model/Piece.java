 ...
 * @param playerId 해당 기물로 전직한 플레이어의 UUID
 */
public record Piece(UUID entityId, PieceSpec spec, UUID playerId) {
    ...
    /**
     * 해당 기물을 특정 플레이어가 전직한 상태로 설정한 새로운 기물 객체를 반환합니다.
     *
     * @param playerId 이 기물로 전직할 플레이어의 UUID
     * @return 플레이어가 설정된 새로운 {@link Piece} 객체
     */
    @NonNull
    ...
    /**
     * 이 기물로 전직한 플레이어가 있는지 확인합니다.
     *
     * @return 전직한 플레이어가 있으면 true, 아니면 false
     */
    ...
    /**
     * 이 기물로 전직한 플레이어의 ID를 {@link Optional}로 반환합니다.
     *
     * @return 플레이어 UUID를 담은 {@link Optional}, 전직한 플레이어가 없으면 빈 {@link Optional}
     */
    @NonNull
